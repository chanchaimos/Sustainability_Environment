...
public partial class export_epi_input_intensity_4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!UserAcc.UserExpired())
        {
            ...
            if (ssTRetunrLoadData_4 != null)
            {
                if (ssTRetunrLoadData_4.lstIn.Count > 0)
                {
                    string sFacility = "";
                    string sYear = "";
    ...
    private void Export_EXCEL(string sFacility, string sYear)
    {
        ...
        string[] Arr_Column = { "Indicator", "Unit", "Target", "Q1 : Jan", "Q1 : Feb", "Q1 : Mar", "Q2 : Apr", "Q2 : May", "Q2 : Jun", "Q3 : Jul", "Q3 : Aug", "Q3 : Sep", "Q4 : Oct", "Q4 : Nov", "Q4 : Dec", "Total Area", "Remark" };
        double[] Arr_ColumnWidth = { 50, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,20, 50 };
        using (XLWorkbook wb = new XLWorkbook())
        {
            ...
            ws.Cell("A2").Value = "Operation Type : PTT Group Building & PTT Research & Technology Institute";
    ...
    public string SetTextDetail(int i, sysGlobalClass.T_TIntensity_Other f)
    {
        ...
        switch (i)
        {
            ...
            case 0:
                ...
                break;
            case 1:
                sText = !string.IsNullOrEmpty(f.sUnit) ? FunctionGetData.ReplaceHtmlUnit(f.sUnit) : "Tonnes Product";
                break;
            //ชื่อเมนู
            case 2:
                sText = f.sTarget + "";
