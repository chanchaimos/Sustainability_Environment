...
using System.IO;
public partial class export_epi_input_intensity_3 : System.Web.UI.Page
{
    private const int nIndicator = 6;
    private const int nOperationType = 13;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!UserAcc.UserExpired())
        {
            ...
            if (ssTRetunrLoadData_3 != null)
            {
                if (ssTRetunrLoadData_3.lstIn.Count > 0)
                {
                    string sFacility = "";
                    string sYear = "";
    ...
    private void Export_EXCEL(string sFacility, string sYear)
    {
        ...
        using (XLWorkbook wb = new XLWorkbook())
        {
            ...
            ws.Cell("A2").Value = "Operation Type : Chemical Transportation & Storage";
