<%@ Page Title="" Language="C#" MasterPageFile="~/_MP_Front.master" AutoEventWireup="true" CodeFile="admin_master_effluent_otherunit_update.aspx.cs" Inherits="admin_effluent_otherunit_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <div class="panel panel-primary">
        ...
        <div class="panel-body" id="divContent">
            <div class="form-horizontal">
                <div class="form-group">
                    <label class="control-label col-xs-12 col-md-3 text-left-sm">Unit Name <span class="text-red">*</span> :</label>
        ...
        <div class="panel-footer text-center">
            ...
            <a class="btn btn-default" href="admin_master_effluent_otherunit_lst.aspx">Cancel</a>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScript" runat="Server">
    <script type="text/javascript">
        $(function () {
            ...
            var objValidate = {};
            objValidate[GetElementName("txtName", objControl.txtbox)] = addValidate_notEmpty(DialogMsg.Specify + " Unit Name");
        ...
        function SaveData() {
            ...
            if (Ispass) {
                var dataValue = {
                    ...
                    sProductID: GetValTextBox('hdfUnitID'),
                };
                DialogConfirm(DialogHeader.Confirm, DialogMsg.ConfirmSave, function () {
                    AjaxCallWebMethod("SaveData", function (response) {
                        ...
                        if (response.d.Status == SysProcess.SessionExpired) {
                            ...
                            DialogSuccessRedirect(DialogHeader.Info, DialogMsg.SaveComplete, "admin_master_effluent_otherunit_lst.aspx");
                        } else {
