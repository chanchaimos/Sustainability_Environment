...
public partial class export_epi_input_intensity_1 : System.Web.UI.Page
{
    private const int nIndicator = 6;
    private const int nOperationType = 4;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!UserAcc.UserExpired())
        {
            ...
            if (ssTRetunrLoadData_1 != null)
            {
                if (ssTRetunrLoadData_1.lstIn.Count > 0)
                {
                    string sFacility = "";
                    string sYear = "";
