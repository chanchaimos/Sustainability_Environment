<%@ Page Title="" Language="C#" MasterPageFile="~/_MP_Intensity.master" AutoEventWireup="true" CodeFile="epi_input_intensity_3.aspx.cs" Inherits="epi_input_intensity_3" %>
            ...
            if (arrCt.lstIn != null) {
                ...
                $.each(arrCt.lstIn, function () {
                    ...
                    if (this.ProductID != 89 && this.ProductID != 90) {
                        ...
                        if (this.ProductID == 85 || this.ProductID == 79) {
                ...
                Enumerable.From(arrCt.lstIn).ForEach(function (f) {
                    ...
                    if (nUnderProduct == 79) {
                        ...
                        for (var k = 1; k <= 12 ; k++) {
                            ...
                            if (nStatusWF > 0) {
                                $("input#txtDetail_" + i + "_" + f.ProductID + "_M" + k).prop('disabled', true);
                            }
                            ...
                            $("input#txtDetail_" + i + "_" + f.ProductID + "_M" + k).val(CheckTextInput(nVal));
                        }
                        nRowDT++;
                    }
                    var sUnit = f.sUnit;
                    ...
                    $("input#txtTargetDetail_" + i).val(CheckTextOutput(f.Target));
                    if ($hdfPRMS.val() == "1" && ($hdfsRoleID.val() != "3" && $hdfsRoleID.val() != "4")) {
                        $("input#txtTargetDetail_" + i).prop('disabled', true);
                    }
