...
public partial class _MP_EPI_FORMS : System.Web.UI.MasterPage
{
    ...
    public string hdfPRMS
    {
        set { hdfPRMSMaster.Value = value; }
        get { return hdfPRMSMaster.Value; }
    }
    public string hdfCheckRole
    {
        set { hdfRole.Value = value; }
        get { return hdfRole.Value; }
    }
}
