<%@ Page Title="" Language="C#" MasterPageFile="~/_MP_Front.master" AutoEventWireup="true" CodeFile="admin_master_effluent_otherproduct_lst.aspx.cs" Inherits="admin_master_effluent_otherproduct_lst" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <div class="panel panel-primary">
        <div class="panel-heading"><i class="fa fa-table"></i>&nbsp;<a href="admin_master_data_lst.aspx" style="color: white !important;">Master Data</a>&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;Effluent Other Indicator</div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-12 col-md-3 col-lg-2">
                                <a class="btn btn-primary btn-sm btn-block" href="admin_master_effluent_otherproduct_update.aspx"><i class="fa fa-plus"></i>&nbsp;Create Product</a>
                            </div>
