<%@ Page Title="" Language="C#" MasterPageFile="~/_MP_Front.master" AutoEventWireup="true" CodeFile="admin_master_emission_otherproduct_update.aspx.cs" Inherits="admin_master_emission_otherproduct_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <div class="panel panel-primary">
        ...
        <div class="panel-footer text-center">
            ...
            <a class="btn btn-default" href="admin_master_emission_otherproduct_lst.aspx">Cancel</a>
        </div>
    </div>
                ...
                DialogConfirm(DialogHeader.Confirm, DialogMsg.ConfirmSave, function () {
                    AjaxCallWebMethod("SaveData", function (response) {
                        ...
                        if (response.d.Status == SysProcess.SessionExpired) {
                            ...
                            DialogSuccessRedirect(DialogHeader.Info, DialogMsg.SaveComplete, "admin_master_emission_otherproduct_lst.aspx");
                        } else {
