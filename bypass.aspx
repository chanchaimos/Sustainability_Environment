<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bypass.aspx.cs" Inherits="bypass" %>
            ...
            <div class="box-login">
                <div class="container">
                    ...
                    <div class="box-form">
                        ...
                        <div class="box-title">
                            <div class="title-main">Enviromental Performance</div>
                    ...
                    <div class="footer-area">
                        <div class="footer-pttgc">
                            <div class="footer-pttgc-icon">
                                <img src="Images/icon-pttgc-footer-new.png" />
                            </div>
