...
public partial class admin_master_emission_otherproduct_update : System.Web.UI.Page
{
    ...
    private void SetData(string sID)
    {
        if (!string.IsNullOrEmpty(sID))
        {
            ...
            var Query = db.TM_Emission_OtherProduct.FirstOrDefault(w => w.nProductID == nID);
            if (Query != null)
            {
